...
const CACHE = 'nucleo-v58';
const ARCHIVOS = ['./', './index.html', './styles/app.css?v=58', './scripts/app.js?v=58', './scripts/resonancia.js?v=58', './registro.js?v=58', './manifest.webmanifest?v=58', './version.json'];
