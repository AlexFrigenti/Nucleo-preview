...
const CACHE = 'nucleo-v57';
const ARCHIVOS = ['./', './index.html', './styles/app.css?v=57', './scripts/app.js?v=57', './scripts/resonancia.js?v=57', './registro.js?v=57', './manifest.webmanifest?v=57', './version.json'];
